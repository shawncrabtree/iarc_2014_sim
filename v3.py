...
#TODO MAKE A BETTER WAY TO CHOSE TARGET - currently stops 
#		looking once all towards green. This is a 
#		problem because the robots hit each other
#		and then turn away from green
